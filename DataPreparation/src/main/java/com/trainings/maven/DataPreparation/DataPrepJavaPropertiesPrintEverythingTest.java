...
public class DataPrepJavaPropertiesPrintEverythingTest {

	public static void main(String[] args) {

		// it loads from src/main/resources/config.properties

		DataPrepJavaPropertiesPrintEverythingTest app = new DataPrepJavaPropertiesPrintEverythingTest();
