...
public class RegisterAccountPage extends AbstractPage {
	...
	public void countFields() {
		System.out.println("Address Fields: " + fieldsAddressInput.size());
		System.out.println("Address Select Fields: " + fieldsAddressSelectInput.size());
		System.out.println("Class Attribute Form Control Fields: " + fieldsClassAttributeFormControl.size());
		System.out.println("Tag Name Fieldset Fields: " + fieldsTagNameFieldset.size());
		System.out.println("Input Fields: " + fieldsInput.size());
	}
